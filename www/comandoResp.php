...
/* 
$nombre = "respaldo_HC.txt";
$nombre = date("Y-M-d")."_".$nombre;
*/
...
/* Conexion y eso*/
$respaldar = "SELECT * FROM `paciente`, `descripcion` WHERE `paciente`.`idPaciente`=descripcion.idPaciente and paciente.idUsuario=".$_SESSION['MM_Username'];
$rsRespaldo = $qualitat->Execute($respaldar) or die($qualitat->ErrorMsg());
...
exportTableDatabase($rsRespaldo);
?> 
<head>
