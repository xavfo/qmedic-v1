...
$rsEditarUsuario = $qualitat->Execute($query_rsEditarUsuario) or die($qualitat->ErrorMsg());
$row_rsEditarUsuario = mysqli_fetch_assoc($rsEditarUsuario);
$totalRows_rsEditarUsuario = $rsEditarUsuario->recordCount();
...
$rsTipoUsuario = $qualitat->Execute($query_rsTipoUsuario) or die($qualitat->ErrorMsg());
$row_rsTipoUsuario = mysqli_fetch_assoc($rsTipoUsuario);
$totalRows_rsTipoUsuario = $rsTipoUsuario->recordCount();
    ...
    <tr valign="baseline">
        ...
        <tr valign="baseline">
          ...
          <td><table border="1" cellpadding="3" cellspacing="0">
            ...
            <?php } while ($row_rsTipoUsuario = mysqli_fetch_assoc($rsTipoUsuario)); ?>
          </table></td>
        </tr>
        <tr valign="baseline">
          <td nowrap align="right">&nbsp;</td>
          <td><p>
            <input type="submit" value="Actualizar" class="btn btn-dark">&nbsp;            </p>          </td>
        </tr>
      </table>
