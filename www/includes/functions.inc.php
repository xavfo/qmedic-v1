...
if (!isset($_SERVER['QUERY_STRING']) && isset($HTTP_ENV_VARS['QUERY_STRING'])) {
  $_SERVER['QUERY_STRING'] = $HTTP_ENV_VARS['QUERY_STRING'];
}
if (!isset($_SERVER['REQUEST_URI']) && isset($HTTP_ENV_VARS['REQUEST_URI'])) {
  $_SERVER['REQUEST_URI'] = $HTTP_ENV_VARS['REQUEST_URI'];
}
if (!isset($_SERVER['HTTP_HOST']) && isset($HTTP_ENV_VARS['HTTP_HOST'])) {
  $_SERVER['HTTP_HOST'] = $HTTP_ENV_VARS['HTTP_HOST'];
}
if (!isset($_SERVER['HTTPS']) && isset($HTTP_ENV_VARS['HTTPS'])) {
  $_SERVER['HTTPS'] = $HTTP_ENV_VARS['HTTPS'];
}
if (!isset($_SERVER['PATH_TRANSLATED']) && isset($HTTP_ENV_VARS['PATH_TRANSLATED'])) {
  $_SERVER['PATH_TRANSLATED'] = $HTTP_ENV_VARS['PATH_TRANSLATED'];
}
if (!isset($_SERVER['SCRIPT_FILENAME']) && isset($HTTP_ENV_VARS['SCRIPT_FILENAME'])) {
  $_SERVER['SCRIPT_FILENAME'] = $HTTP_ENV_VARS['SCRIPT_FILENAME'];
}

if (!isset($_SERVER['HTTP_REFERER']) && isset($HTTP_ENV_VARS['HTTP_REFERER'])) {
  $_SERVER['HTTP_REFERER'] = $HTTP_ENV_VARS['HTTP_REFERER'];
}
if (!isset($_SERVER['HTTP_USER_AGENT']) && isset($HTTP_ENV_VARS['HTTP_USER_AGENT'])) {
  $_SERVER['HTTP_USER_AGENT'] = $HTTP_ENV_VARS['HTTP_USER_AGENT'];
}
